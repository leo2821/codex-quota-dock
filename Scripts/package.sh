...
APP_DIR="$OUTPUT_DIR/Codex Quota Dock.app"
...
ditto "$BUILD_DIR/release/CodexAccounts_AccountCore.bundle" "$APP_DIR/Contents/Resources/CodexAccounts_AccountCore.bundle"
